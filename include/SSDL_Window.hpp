...
namespace SSDL {
     ...
     *
     * @warning Please only generate one! SSDL::Window object
     * @bug Surface is getting free by SSDL::Surface, I'm not sure but according documentation is that false and can produce a memory-leak
     */

    class Window : public SSDL::DrawingArea {
    private:
    ...
    private:
         ...
         *
         * @throw 1 Unable to set video mode
         */
